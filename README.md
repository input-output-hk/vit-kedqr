...
- or if you have [Go](https://golang.org/dl) installed use: `go get github.com/input-output-hk/vit-kedqr`
  - if you want to build from the source use ie: `CGO_ENABLED=0 go build -trimpath -ldflags="-s -w" main.go`
